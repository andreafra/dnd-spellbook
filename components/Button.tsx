...
export const Button = (props: ButtonProps) => (
	<BaseButton
		{...props}
		className={`border-transparent bg-primaryLight-50 text-primaryLight-800 hover:border-primaryLight-300 active:border-primaryLight-300 active:bg-primaryLight-200 disabled:opacity-30 disabled:active:bg-transparent disabled:active:text-primaryLight-50`}
	/>
)
